#!/usr/bin/env python3
"""
final_solver.py - Optimized Tree Packing Solver

Uses pre-computed patterns + efficient incremental building.
...
class Solver:
    ...
    def solve_n(self, n):
        ...
        # Quick optimization - scale with sqrt(n)
...
def main():
    ...
    for seed in [42, 123]:
        print(f"\nSeed: {seed}")
        solver = Solver(seed=seed, verbose=True)
